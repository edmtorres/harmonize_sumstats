...
def main():
    ...
    parser.add_argument("--genome-build", "-g", type=str, required=True, choices=["hg19", "hg38"], help="Genome build of the GWAS file (e.g: hg19, hg38)")
    parser.add_argument("--ip-path", "-i", type=str, required=True, help="File path to input GWAS dataset")
    parser.add_argument("--op-path", "-o", type=str, required=True, help="File path to save output file")
